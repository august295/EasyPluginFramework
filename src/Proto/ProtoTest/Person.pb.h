...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_Person_2eproto PROTO_EXPORT
...
struct PROTO_EXPORT TableStruct_Person_2eproto {
  static const uint32_t offsets[];
};
PROTO_EXPORT extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Person_2eproto;
namespace TEST {
class Person;
struct PersonDefaultTypeInternal;
PROTO_EXPORT extern PersonDefaultTypeInternal _Person_default_instance_;
}  // namespace TEST
PROTOBUF_NAMESPACE_OPEN
template<> PROTO_EXPORT ::TEST::Person* Arena::CreateMaybeMessage<::TEST::Person>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace TEST {

// ===================================================================

class PROTO_EXPORT Person final :
 ...
 public:
  ...
  int32_t phone_num() const;
  void set_phone_num(int32_t value);
  private:
  int32_t _internal_phone_num() const;
  void _internal_set_phone_num(int32_t value);
  public:
...
inline double Person::salary() const {
  // @@protoc_insertion_point(field_get:TEST.Person.salary)
...
inline void Person::set_salary(double value) {
  ...
  // @@protoc_insertion_point(field_set:TEST.Person.salary)
}

// int32 phone_num = 5;
inline void Person::clear_phone_num() {
  phone_num_ = 0;
}
inline int32_t Person::_internal_phone_num() const {
  return phone_num_;
}
inline int32_t Person::phone_num() const {
  // @@protoc_insertion_point(field_get:TEST.Person.phone_num)
  return _internal_phone_num();
}
inline void Person::_internal_set_phone_num(int32_t value) {
  
  phone_num_ = value;
}
inline void Person::set_phone_num(int32_t value) {
  _internal_set_phone_num(value);
  // @@protoc_insertion_point(field_set:TEST.Person.phone_num)
}
