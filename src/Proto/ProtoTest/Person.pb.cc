...
const uint32_t TableStruct_Person_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::TEST::Person, salary_),
  PROTOBUF_FIELD_OFFSET(::TEST::Person, phone_num_),
};
...
uint8_t* Person::_InternalSerialize(
  ...
  if (this->_internal_phone_num() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(5, this->_internal_phone_num(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:TEST.Person)
  ...
  // int32 phone_num = 5;
  if (this->_internal_phone_num() != 0) {
    total_size += ::_pbi::WireFormatLite::Int32SizePlusOne(this->_internal_phone_num());
  }
